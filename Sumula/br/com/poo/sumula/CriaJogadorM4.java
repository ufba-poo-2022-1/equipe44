...
public class CriaJogadorM4 implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == confirma) {
			...
			Main.getSumula().mandante4.setText(passaNumero());
		...
		if (e.getSource() == sub) {
			if (Main.getSumula().mandante.toString().contains(numText.getText())) {
				for (Jogador j : Main.getSumula().mandante.jogadores) {
					if (j.numero.equals(Main.getSumula().mandante4.getText())) {
			...
			Main.getSumula().mandante4.setText("#0");
