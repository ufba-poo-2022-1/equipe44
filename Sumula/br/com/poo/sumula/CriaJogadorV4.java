...
public class CriaJogadorV4 implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == sub) {
			if (Main.getSumula().visitante.toString().contains(numText.getText())) {
				for (Jogador j : Main.getSumula().visitante.jogadores) {
					if (j.numero.equals(Main.getSumula().visitante4.getText())) {
			...
			Main.getSumula().visitante4.setText("#0");
