...
public class CriaJogadorV5 implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == sub) {
			if (Main.getSumula().visitante.toString().contains(numText.getText())) {
				for (Jogador j : Main.getSumula().visitante.jogadores) {
					if (j.numero.equals(Main.getSumula().visitante5.getText())) {
			...
			Main.getSumula().visitante5.setText("#0");
