...
public class CriaJogadorM2 implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == confirma) {
			...
			Main.getSumula().mandante2.setText(passaNumero());
		...
		if (e.getSource() == sub) {
			if (Main.getSumula().mandante.toString().contains(numText.getText())) {
				for (Jogador j : Main.getSumula().mandante.jogadores) {
					if (j.numero.equals(Main.getSumula().mandante2.getText())) {
			...
			Main.getSumula().mandante2.setText("#0");
