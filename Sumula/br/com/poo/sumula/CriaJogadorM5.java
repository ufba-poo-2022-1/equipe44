...
public class CriaJogadorM5 implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == confirma) {
			...
			Main.getSumula().mandante5.setText(passaNumero());
		...
		if (e.getSource() == sub) {
			if (Main.getSumula().mandante.toString().contains(numText.getText())) {
				for (Jogador j : Main.getSumula().mandante.jogadores) {
					if (j.numero.equals(Main.getSumula().mandante5.getText())) {
			...
			Main.getSumula().mandante5.setText("#0");
