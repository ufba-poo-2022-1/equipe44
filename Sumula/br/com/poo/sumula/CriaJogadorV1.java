...
public class CriaJogadorV1 implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == confirma) {
			...
			Main.getSumula().visitante1.setText(passaNumero());
		...
		if (e.getSource() == sub) {
			if (Main.getSumula().visitante.toString().contains(numText.getText())) {
				for (Jogador j : Main.getSumula().visitante.jogadores) {
					if (j.numero.equals(Main.getSumula().visitante1.getText())) {
			...
			Main.getSumula().visitante1.setText("#0");
